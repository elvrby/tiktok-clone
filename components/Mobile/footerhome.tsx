    ...
    return (
        <footer className="bgfillm fixed bottom-0 left-0 w-full pl-1 pb-2 pr-1 pt-3 flex justify-around items-center md:hidden text-[9px]">
            <div className="flex w-full justify-between">
                <Link href="/home" passHref className="text-center flex flex-col items-center flex-1">
                ...
                <Link href="/discover" passHref className="text-center flex flex-col items-center flex-1">
                <div className="text-center flex flex-col items-center flex-1">
                ...
                <Link href="/upload" passHref className="text-center flex flex-col items-center flex-1">
                <div className="text-center flex flex-col items-center flex-1 justify-center">
                    <svg className="w-12 h-8" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path className="ofillre" d="M12.5934 9.62756C12.0884 9.62756 11.5834 9.62756 11.1099 9.62756C10.7312 9.62756 10.5734 9.53287 10.5734 9.12256C10.5734 8.68069 10.7628 8.61756 11.1415 8.61756C12.1199 8.61756 13.0984 8.61756 14.0452 8.61756C14.424 8.61756 14.5818 8.55444 14.5818 8.11256C14.5502 7.26038 14.5502 6.4082 14.5818 5.55602C14.5818 5.17727 14.2662 4.57758 15.1184 4.60915C15.9074 4.60915 15.5918 5.17727 15.6234 5.52445C15.6549 6.34507 15.6865 7.16569 15.6234 8.01788C15.6234 8.52287 15.7812 8.61756 16.2546 8.61756C17.1383 8.586 18.0221 8.61756 18.9374 8.61756C19.3161 8.61756 19.4108 8.77537 19.4108 9.12256C19.4108 9.50131 19.3477 9.65912 18.9374 9.62756C18.0537 9.62756 17.1699 9.62756 16.2546 9.62756C15.718 9.62756 15.5918 9.78537 15.6234 10.2904C15.6549 11.1425 15.6234 12.0263 15.6234 12.91C15.6234 13.3203 15.4971 13.4466 15.0868 13.4466C14.6765 13.4466 14.5502 13.3203 14.5502 12.91C14.5502 11.9947 14.5502 11.0479 14.5502 10.1326C14.5502 9.75381 14.424 9.62756 14.0768 9.65912C13.5718 9.69068 13.0984 9.65912 12.5934 9.65912V9.62756Z" fill="black"/>
                    </svg>
                </div>
                </Link>

                <Link href="/inbox" passHref className="text-center flex flex-col items-center flex-1">
                <div className="text-center flex flex-col items-center flex-1">
                    <svg className="w-6 h-6" viewBox="0 0 29 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path className="ostroke" d="M10.5672 24.3835L10.2707 24.0655H9.83583H1V1H27.9898L27.7583 23.8488L19.1242 24.1941L18.7287 24.2099L18.4512 24.4921L14.4564 28.5543L10.5672 24.3835ZM20.271 15.882H21.271V14.882V11.884V10.884H20.271H8.5985H7.5985V11.884V14.882V15.882H8.5985H20.271Z" stroke="white" stroke-width="1" />
                    </svg>
...
export default FooterMobileHome;
