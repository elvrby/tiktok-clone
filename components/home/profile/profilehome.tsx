                ...
                <div className="w-full flex items-center justify-between p-2">
                    ...
                    <div className="flex justify-center w-56">
                        <div className="flex items-center">
                            ...
                            <path d="M1 1L11.5 13L22 1" className="ostroke" strokeWidth={3}/>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div>
                        <button>
                            <svg className="w-4" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path className="ofill" d="M12.5149 0.936037H0.485074C0.356425 0.936037 0.233044 0.886728 0.142075 0.798958C0.0511059 0.711187 0 0.592145 0 0.468019C0 0.343892 0.0511059 0.22485 0.142075 0.137079C0.233044 0.0493086 0.356425 0 0.485074 0H12.5149C12.6436 0 12.767 0.0493086 12.8579 0.137079C12.9489 0.22485 13 0.343892 13 0.468019C13 0.592145 12.9489 0.711187 12.8579 0.798958C12.767 0.886728 12.6436 0.936037 12.5149 0.936037Z" />
                                <path className="ofill" d="M12.5149 4.46802H0.485075C0.356425 4.46802 0.233044 4.41871 0.142075 4.33094C0.051106 4.24317 6.46176e-08 4.12413 6.46176e-08 4C6.46176e-08 3.87587 0.051106 3.75683 0.142075 3.66906C0.233044 3.58129 0.356425 3.53198 0.485075 3.53198H12.5149C12.6436 3.53198 12.767 3.58129 12.8579 3.66906C12.9489 3.75683 13 3.87587 13 4C13 4.12413 12.9489 4.24317 12.8579 4.33094C12.767 4.41871 12.6436 4.46802 12.5149 4.46802Z" />
                                <path className="ofill" d="M12.5149 8H0.485075C0.356425 8 0.233044 7.95069 0.142075 7.86292C0.051106 7.77515 6.46176e-08 7.65611 6.46176e-08 7.53198C6.46176e-08 7.40785 0.051106 7.28881 0.142075 7.20104C0.233044 7.11327 0.356425 7.06396 0.485075 7.06396H12.5149C12.6436 7.06396 12.767 7.11327 12.8579 7.20104C12.9489 7.28881 13 7.40785 13 7.53198C13 7.65611 12.9489 7.77515 12.8579 7.86292C12.767 7.95069 12.6436 8 12.5149 8Z" />
                            </svg>
                        </button>
                    </div>
                </div>
            ...
            <div className="relative w-full h-full overflow-y-auto text-center flex justify-center md:hidden">
                <div className="w-full pt-20">
                    ...
                    <div className="w-full flex items-center justify-center mt-4">
                        <button className="bg-[#4A4A4A] w-auto p-2 pl-5 pr-5 rounded-md text-sm mr-1 text-white">Edit Profile</button>
                        <button className="bg-[#4A4A4A] w-auto p-2 pl-5 pr-5 rounded-md text-sm mr-1 text-white">Share Profile</button>
                    ...
                    <div className="w-full justify-between p-8 pl-12 pr-12 pb-4 flex border-b border-[#4A4A4A]">
                        <div>
                            <svg className="ofill" width="26" height="22" viewBox="0 0 34 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.76296 0H0V9.68901H1.76296V0Z"/>
                                <path d="M10.179 0H8.41605V9.68901H10.179V0Z" />
                                <path d="M18.1543 0H16.3914V9.68901H18.1543V0Z" />
                                <path d="M1.76296 12.311H0V22H1.76296V12.311Z" />
                                <path d="M10.179 12.311H8.41605V22H10.179V12.311Z" />
                                <path d="M18.1543 12.311H16.3914V22H18.1543V12.311Z" />
                                <path d="M25.4161 9.19739H34L29.7185 14.0112L25.4161 9.19739Z" />
                            </svg>
                        </div>
                        <div>
                            <svg width="18" height="30" viewBox="0 0 25 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22.8187 12.55H1.29438C1.1318 12.55 1 12.6818 1 12.8444V28.1348C1 28.2974 1.1318 28.4292 1.29438 28.4292H22.8187C22.9812 28.4292 23.113 28.2974 23.113 28.1348V12.8444C23.113 12.6818 22.9812 12.55 22.8187 12.55Z" className="ostroke" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M18.403 12.4635C18.403 12.4635 19.5805 1 11.9786 1C4.37669 1 5.60616 12.4635 5.60616 12.4635" className="ostroke" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M13.2773 16.8445H10.4374V23.3728H13.2773V16.8445Z" className="ofill"/>
                            </svg>
                        </div>
                        <div>
                            <svg width="20" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.22 18.9269L1 27.6082V2.62972C1 1.73651 1.72084 1 2.62972 1H20.2745C21.1677 1 21.9042 1.72084 21.9042 2.62972V28.0783" className="ostroke" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M28 17.3755C28 17.3755 24.2234 12.1103 19.538 12.1103C14.8526 12.1103 11.4521 17.6106 11.4521 17.6106C11.4521 17.6106 15.2287 22.9071 20.1962 22.9071C25.1637 22.9071 27.5769 18.1434 27.5769 18.1434L28 17.3755Z" className="ostroke" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M23.2234 17.4273C23.2618 17.4715 23.2968 17.5128 23.3282 17.5504C23.306 17.5859 23.2814 17.6242 23.2545 17.665C23.0992 17.9008 22.8689 18.2142 22.5699 18.5259C21.964 19.1573 21.13 19.7275 20.1021 19.7275C19.0538 19.7275 18.0935 19.1651 17.3617 18.5453C17.0019 18.2406 16.7125 17.9347 16.5133 17.705C16.4829 17.6701 16.4548 17.6369 16.4288 17.6059C16.4515 17.575 16.476 17.542 16.5023 17.5073C16.6826 17.2697 16.9449 16.9538 17.2729 16.6396C17.9431 15.9974 18.8145 15.4309 19.7731 15.4309C20.7457 15.4309 21.6692 15.9801 22.388 16.5957C22.74 16.8971 23.0257 17.1998 23.2234 17.4273Z" className="ostroke"/>
                            <path d="M12.5961 11.1387L14.4295 9.88509L27.9843 23.8944L26.1352 25.148L12.5961 11.1387Z" className="ofill"/>
                            </svg>
                        </div>
                        <div>
                            <svg width="20" height="27" viewBox="0 0 29 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M27 18.0993C27 18.0993 23.8112 13.6619 19.8462 13.6619C15.8812 13.6619 13.0298 18.3017 13.0298 18.3017C13.0298 18.3017 16.2187 22.7729 20.4199 22.7729C24.621 22.7729 27 18.0993 27 18.0993Z" className="ostroke" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M22.9052 18.1885C22.9218 18.2076 22.9376 18.226 22.9527 18.2436C22.9441 18.2569 22.9353 18.2705 22.9261 18.2845C22.7968 18.4814 22.6054 18.7427 22.3572 19.0023C21.8529 19.5299 21.1693 19.9951 20.3355 19.9951C19.4801 19.9951 18.6862 19.5346 18.0723 19.0164C17.7715 18.7625 17.5291 18.5074 17.3622 18.3159C17.3515 18.3037 17.3412 18.2918 17.3313 18.2802C17.3392 18.2695 17.3474 18.2587 17.3558 18.2476C17.506 18.0491 17.7244 17.7854 17.9971 17.5234C18.557 16.9855 19.2723 16.524 20.0486 16.524C20.8391 16.524 21.6016 16.9742 22.2056 17.4919C22.5 17.7442 22.7395 17.9978 22.9052 18.1885Z" className="ostroke"/>
                            <mask id="path-3-inside-1_181_28" fill="white">
                            <path d="M13.9916 12.8183L15.5438 11.7722L26.9831 23.5996L25.4309 24.6457L13.9916 12.8183Z"/>
                            </mask>
                            <path d="M13.9916 12.8183L12.8739 11.1598L10.8949 12.4934L12.554 14.2087L13.9916 12.8183ZM15.5438 11.7722L16.9814 10.3818L15.8161 9.17694L14.4261 10.1137L15.5438 11.7722ZM26.9831 23.5996L28.1008 25.2581L30.0798 23.9245L28.4207 22.2092L26.9831 23.5996ZM25.4309 24.6457L23.9933 26.0361L25.1586 27.2409L26.5486 26.3042L25.4309 24.6457ZM15.1093 14.4768L16.6615 13.4307L14.4261 10.1137L12.8739 11.1598L15.1093 14.4768ZM14.1062 13.1626L25.5455 24.99L28.4207 22.2092L16.9814 10.3818L14.1062 13.1626ZM25.8654 21.9411L24.3132 22.9871L26.5486 26.3042L28.1008 25.2581L25.8654 21.9411ZM26.8685 23.2552L15.4292 11.4279L12.554 14.2087L23.9933 26.0361L26.8685 23.2552Z" className="ofill" mask="url(#path-3-inside-1_181_28)"/>
                            <path d="M16.843 21.9293C14.9195 23.7683 13.4517 25 13.4517 25C13.4517 25 1 15.889 1 8.85334C1 1.81765 6.6353 0.990912 8.92992 2.12135C10.4653 2.88059 13.2154 5.69825 13.2154 5.69825C13.2154 5.69825 16.1343 1.76703 19.6437 1.76703C23.1531 1.76703 26.072 5.31019 26.072 8.80272C26.072 12.2953 24.756 12.6875 23.44 14.6109" className="ostroke" stroke-width="2" stroke-miterlimit="10"/>
                            </svg>
                        </div>
