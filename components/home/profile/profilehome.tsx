            ...
            <div className="relative w-full h-full overflow-y-auto text-center flex justify-center md:hidden">
                <div className="w-full pt-20">
                    ...
                    <div className="w-full justify-between p-8 pl-12 pr-12 pb-4 flex border-b border-[#4A4A4A]">
                        <div>
                            <svg width="30" height="22" viewBox="0 0 34 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.76296 0H0V9.68901H1.76296V0Z" fill="white"/>
                                <path d="M10.179 0H8.41605V9.68901H10.179V0Z" fill="white"/>
                                <path d="M18.1543 0H16.3914V9.68901H18.1543V0Z" fill="white"/>
                                <path d="M1.76296 12.311H0V22H1.76296V12.311Z" fill="white"/>
                                <path d="M10.179 12.311H8.41605V22H10.179V12.311Z" fill="white"/>
                                <path d="M18.1543 12.311H16.3914V22H18.1543V12.311Z" fill="white"/>
                                <path d="M25.4161 9.19739H34L29.7185 14.0112L25.4161 9.19739Z" fill="white"/>
                            </svg>
                        </div>
                        <div>
                            <svg width="20" height="30" viewBox="0 0 25 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M22.8187 12.55H1.29438C1.1318 12.55 1 12.6818 1 12.8444V28.1348C1 28.2974 1.1318 28.4292 1.29438 28.4292H22.8187C22.9812 28.4292 23.113 28.2974 23.113 28.1348V12.8444C23.113 12.6818 22.9812 12.55 22.8187 12.55Z" stroke="white" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M18.403 12.4635C18.403 12.4635 19.5805 1 11.9786 1C4.37669 1 5.60616 12.4635 5.60616 12.4635" stroke="white" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M13.2773 16.8445H10.4374V23.3728H13.2773V16.8445Z" fill="white"/>
                            </svg>
                        </div>
                        <div>
                            <svg width="25" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.22 18.9269L1 27.6082V2.62972C1 1.73651 1.72084 1 2.62972 1H20.2745C21.1677 1 21.9042 1.72084 21.9042 2.62972V28.0783" stroke="white" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M28 17.3755C28 17.3755 24.2234 12.1103 19.538 12.1103C14.8526 12.1103 11.4521 17.6106 11.4521 17.6106C11.4521 17.6106 15.2287 22.9071 20.1962 22.9071C25.1637 22.9071 27.5769 18.1434 27.5769 18.1434L28 17.3755Z" stroke="white" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M23.2234 17.4273C23.2618 17.4715 23.2968 17.5128 23.3282 17.5504C23.306 17.5859 23.2814 17.6242 23.2545 17.665C23.0992 17.9008 22.8689 18.2142 22.5699 18.5259C21.964 19.1573 21.13 19.7275 20.1021 19.7275C19.0538 19.7275 18.0935 19.1651 17.3617 18.5453C17.0019 18.2406 16.7125 17.9347 16.5133 17.705C16.4829 17.6701 16.4548 17.6369 16.4288 17.6059C16.4515 17.575 16.476 17.542 16.5023 17.5073C16.6826 17.2697 16.9449 16.9538 17.2729 16.6396C17.9431 15.9974 18.8145 15.4309 19.7731 15.4309C20.7457 15.4309 21.6692 15.9801 22.388 16.5957C22.74 16.8971 23.0257 17.1998 23.2234 17.4273Z" stroke="white"/>
                            <path d="M12.5961 11.1387L14.4295 9.88509L27.9843 23.8944L26.1352 25.148L12.5961 11.1387Z" fill="white"/>
                            </svg>
                        </div>
                        <div>
                            <svg width="25" height="27" viewBox="0 0 29 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M27 18.0993C27 18.0993 23.8112 13.6619 19.8462 13.6619C15.8812 13.6619 13.0298 18.3017 13.0298 18.3017C13.0298 18.3017 16.2187 22.7729 20.4199 22.7729C24.621 22.7729 27 18.0993 27 18.0993Z" stroke="white" stroke-width="2" stroke-miterlimit="10"/>
                            <path d="M22.9052 18.1885C22.9218 18.2076 22.9376 18.226 22.9527 18.2436C22.9441 18.2569 22.9353 18.2705 22.9261 18.2845C22.7968 18.4814 22.6054 18.7427 22.3572 19.0023C21.8529 19.5299 21.1693 19.9951 20.3355 19.9951C19.4801 19.9951 18.6862 19.5346 18.0723 19.0164C17.7715 18.7625 17.5291 18.5074 17.3622 18.3159C17.3515 18.3037 17.3412 18.2918 17.3313 18.2802C17.3392 18.2695 17.3474 18.2587 17.3558 18.2476C17.506 18.0491 17.7244 17.7854 17.9971 17.5234C18.557 16.9855 19.2723 16.524 20.0486 16.524C20.8391 16.524 21.6016 16.9742 22.2056 17.4919C22.5 17.7442 22.7395 17.9978 22.9052 18.1885Z" stroke="white"/>
